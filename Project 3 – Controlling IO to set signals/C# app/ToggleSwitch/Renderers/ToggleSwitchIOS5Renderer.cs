...
namespace JCS
{
    public class ToggleSwitchIOS5Renderer : ToggleSwitchRendererBase
    {
        ...
        public ToggleSwitchIOS5Renderer()
        {
            ...
            LeftSideUpperColor1 = Color.ForestGreen;
            LeftSideUpperColor2 = Color.DarkGreen;
            LeftSideLowerColor1 = Color.Green;
            LeftSideLowerColor2 = Color.LightGreen;
            RightSideUpperColor1 = Color.DarkRed;
            RightSideUpperColor2 = Color.OrangeRed;
            RightSideLowerColor1 = Color.Red;
            RightSideLowerColor2 = Color.IndianRed;
            ButtonNormalOuterBorderColor = Color.Black;
            ButtonNormalInnerBorderColor = Color.Black;
            ButtonNormalSurfaceColor1 = Color.Silver;
            ButtonNormalSurfaceColor2 = Color.Silver;
            ButtonHoverOuterBorderColor = Color.Black;
            ButtonHoverInnerBorderColor = Color.Black;
            ButtonHoverSurfaceColor1 = Color.Silver;
            ButtonHoverSurfaceColor2 = Color.Silver;
            ButtonPressedOuterBorderColor = Color.Black;
            ButtonPressedInnerBorderColor = Color.Black;
            ButtonPressedSurfaceColor1 = Color.Silver;
            ButtonPressedSurfaceColor2 = Color.Silver;
